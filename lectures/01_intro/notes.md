...
## Содержание
- [1. Что такое ISA](#1-что-такое-isa)
- [2. Что такое RV32I](#2-что-такое-rv32i)
- [3. Из каких частей состоит простой процессор](#3-из-каких-частей-состоит-простой-процессор)
- [4. Как выполняется одна инструкция](#4-как-выполняется-одна-инструкция)
- [5. Регистры x0-x31 и почему x0--0](#5-регистры-x0-x31-и-почему-x0--0)
- [6. Почему RISC-V — load/store](#6-почему-risc-v--loadstore)
- [7. Адресация lw и sw](#7-адресация-lw-и-sw)
