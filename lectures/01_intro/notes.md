...
- [5. Что такое регистры x0…x31 и почему x0 всегда равен нулю]()
...
## Из каких частей состоит простой процессор
...
## Как выполняется одна инструкция
...
## Что такое регистры x0…x31 и почему x0 всегда равен нулю
...
## Почему RISC-V — load/store архитектура
